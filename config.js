...
module.exports = {
    ...
    ownerName: process.env.OWNER_NAME || "Andrewy", // Owner name

    ownerNumber: process.env.OWNER_NUMBER || "233500850221", // Your WhatsApp number

    mode: process.env.MODE || "public", // Bot mode: 'public' or 'private'

    region: process.env.REGION || "Ghana", // Region

    botName: process.env.BOT_NAME || "Rias Gremory V3", // Bot name

    exifPack: process.env.EXIF_PACK || "RIAS V3 LOVES", // Sticker pack name

    exifAuthor: process.env.EXIF_AUTHOR || "Andrew", // Author of the sticker pack

    timeZone: process.env.TIME_ZONE || "Africa/Ghana", // Time zone
